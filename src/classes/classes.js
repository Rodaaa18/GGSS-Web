...
export const inputButtonClasess= {
  ...
  "classTwo" : 'd-flex flex-row justify-content-start align-items-center w-100',
  "classThree" : 'formulario__label',
  "classFour" : 'formulario-input-InpButton-TipoDNI form-select ml-0 px-0 obligatorio',
  "classFive" : "btn btn-validacion btn-outline-danger btn-sm",
}
export const inputButtonClasessDNI= {
  "classOne" : "formulario__grupo__inputs-Button mt-2",
  "classTwo" : 'd-flex flex-row justify-content-start align-items-center w-100',
  "classThree" : 'formulario__label__DNI',
  "classFour" : 'formulario-input-InpButton-TipoDNI form-select ml-0 px-0 obligatorio',
  "classFive" : "btn btn-validacion btn-outline-danger btn-sm",
}
...
export const classesFormDP={
  classOne : "formulario__grupo__inputs-Button mt-2" ,
  classTwo : 'd-flex flex-row justify-content-start align-items-center w-100',
  classThree : "formulario__label",
  classFive : "formulario-input-Legajo ",
  classSix : "formulario-input-Legajo",
}
export const classesFormDPPagos={
  classOne : "formulario__grupo__inputs-Button mt-2 w-100" ,
  classTwo : 'd-flex flex-row justify-content-start align-items-center w-100',
  classThree : "formulario__label",
  classFive : "formulario-input-Legajo w-100",
  classSix : "formulario-input-Legajo",
}
export const classesFormDPEC = {
  classOne : "formulario__grupo__inputs-Button " ,
  classTwo : 'd-flex flex-row justify-content-start align-items-center w-100',
  classThree : "formulario__label",
  classFive : "formulario-input-Legajo ",
  classSix : "formulario-input-Legajo",
}
export const classesFormDPNone={
  classOne : "formulario__grupo__inputs-Button mt-2 w-100" ,
  classTwo : 'd-flex flex-row justify-content-end align-items-center w-100',
  classThree : "none",
  classFive : "formulario-input-Legajo-TipoDNI ",
  classSix : "formulario-input-Legajo",
}
export const inputButtonClasessParentesco={
  "classOne" : "formulario__grupo__inputs-Button mt-2 w-100",
  "classTwo" : 'd-flex flex-row justify-content-start align-items-center w-100',
  "classThree" : 'formulario__label',
  "classFour" : 'formulario-input-InpButton-TipoDNI form-select ml-0 px-0 obligatorio w-100'
}

export const inputButtonClasessTextArea={
  "classOne" : "formulario__grupo__inputs-Button mt-2 w-100",
  "classTwo" : 'd-flex flex-row justify-content-start align-items-center w-100',
  "classThree" : 'formulario__label',
  "classFour" : 'formulario-input-InpButton-TipoDNI-Area ml-0 px-0 obligatorio '
}
export const clasessInputDate = {
  classOne : "formulario__grupo__inputs w-100" ,
  classTwo : 'd-flex flex-row justify-content-end align-items-center w-100 border border-3',
  classThree : "formulario__label",
  classFour : "select-date-DatosPerson",
  classFive : "d-flex flex-row justify-content-start align-items-center w-100 border border-2",
  classSix : "form-check-input w-100",
  classSeven : "secondCheck w-100"
}